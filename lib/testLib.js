...
class testLib {
  ...
  async checkIcoStageDates(crowdsale, preSaleStartDate, preSaleEndDate, generalSaleStartDate, generalSaleEndDate) {
    if (preSaleStartDate && preSaleEndDate) {
      const preSaleStartDate = (await crowdsale.preSaleStartDate()).toNumber();
      const preSaleEndDate = (await crowdsale.preSaleEndDate()).toNumber();
      // console.log('preSaleStartDate', preSaleStartDate, 'preSaleEndDate', preSaleEndDate);
      assert.equal(preSaleStartDate, preSaleStartDate, 'Pre-sale start date should be set accordingly to crowdsale conditions');
      assert.equal(preSaleEndDate, preSaleEndDate, 'Pre-sale end date should be set accordingly to crowdsale conditions');
    }
  ...
  async checkWithdrawalIsAllowed(crowdsale, owner, bank){
    ...
    // console.log('amountToWithdraw = ', amount.toNumber());
